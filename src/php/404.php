	...
	<main id="primary" class="site-main  grow-1 p">
		...
		<section class="error-404 not-found">
			...
			<div class="page-content">
				...
				$mesh_themplate_archive_content = '<p>' . sprintf(esc_html__('Try looking in the monthly archives. %1$s', 'mesh-themplate'), convert_smilies(':)')) . '</p>';
				the_widget('WP_Widget_Archives', 'dropdown=1', "after_title=</h2>$mesh_themplate_archive_content");
