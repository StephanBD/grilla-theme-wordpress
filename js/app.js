...
/***/ "./src/scss/gutenberg-styles.scss":
/*!****************************************!*\
  !*** ./src/scss/gutenberg-styles.scss ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  $.ajax({
    ...
    success: function success(response) {
      ...
      for (var i = 0; i < response.length; i++) {
        var html = "<li id=\"".concat(response[i].id, "\"><a href=\"").concat(response[i].permalink, "\">").concat(response[i].title, ": ").concat(response[i].precio, "</a></li>");
...
document.querySelectorAll(".menu-dropdown-icon").forEach(function (item) {
  // console.log(item);
  item.addEventListener("click", function (e) {
    ...
    e.preventDefault();
    e.stopPropagation(); // item.nextElementSibling.classList.toggle("md:show-block")
...
var navbarToggle = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_0__.query)(".navbar-toggle");

if (navbarToggle) {
  // console.log(prefresDarkScheme.matches); // true ( dark mode) - false
  var toogleDarkMode = function toogleDarkMode(theme, toggle) {
    console.log("toggle");
    i.classList.toggle("fa-moon");
    i.classList.toggle("fa-sun");
    (0,_helpers_js__WEBPACK_IMPORTED_MODULE_0__.query)("body").classList[toggle]("light-theme"); // localstorage ----

    localStorage.setItem('theme', theme);
  };

  navbarToggle.addEventListener("click", function () {
    (0,_helpers_js__WEBPACK_IMPORTED_MODULE_0__.query)(".navbar-list").classList.toggle("md:show");
  }); // --------------------------------
  // 🗛

  (0,_helpers_js__WEBPACK_IMPORTED_MODULE_0__.query)("#font-deincrease").addEventListener("click", function () {
  ...
  (0,_helpers_js__WEBPACK_IMPORTED_MODULE_0__.query)("#font-increase").addEventListener("click", function () {
    var fontSize = parseInt(getComputedStyle(document.documentElement).getPropertyValue('--font-size-adjust')) + 1 + "px";
    document.documentElement.style.setProperty('--font-size-adjust', fontSize);
  }); // 👁️
  ...
  var prefresDarkScheme = window.matchMedia('(prefers-color-scheme: dark)');
  var darkThemeBtn = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_0__.query)("#dark-theme");
  var i = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_0__.query)("i", darkThemeBtn);
  ...
  darkThemeBtn.addEventListener("click", function (e) {
    e.preventDefault();
    console.log((0,_helpers_js__WEBPACK_IMPORTED_MODULE_0__.query)("body").classList.contains("light-theme"));

    if ((0,_helpers_js__WEBPACK_IMPORTED_MODULE_0__.query)("body").classList.contains("light-theme")) {
      toogleDarkMode("dark", "remove"); // console.log("remove");
    } else {
      toogleDarkMode("light", "add"); // console.log("add");
    }
  });
}
...
/******/ 	__webpack_require__.O(undefined, ["css/gutenberg-styles","css/main"], () => (__webpack_require__("./src/js/app.js")))
/******/ 	__webpack_require__.O(undefined, ["css/gutenberg-styles","css/main"], () => (__webpack_require__("./src/scss/main.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/gutenberg-styles","css/main"], () => (__webpack_require__("./src/scss/gutenberg-styles.scss")))
